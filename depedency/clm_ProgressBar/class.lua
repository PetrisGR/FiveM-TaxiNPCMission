exports("TimerBarBase", function(Type, title, text, numCheckpoints)
    local CAS = exports[GetCurrentResourceName()]:GetCoordsAndSizes()

    local self = {
        _Type = Type,
        _id = exports[GetCurrentResourceName()]:generateRandomString(8),
        _thin = false,
        _color = {255, 255, 255, 255},
        _inProgressColor = {255, 255, 255, 51},
        _failedColor = {0, 0, 0, 255},
        _checkpointStates = {},
        _numCheckpoints = numCheckpoints ~= nil and exports[GetCurrentResourceName()]:clamp(numCheckpoints, 0, 16) or nil,
        _title = title or "",
        _highlightColor = nil,
        _text = text or "",
        titleDrawParams = {
    ...
    local Func = {
        lib = {
            TextTimerBar = {
                ...
                setTextColor = function(value)
                    self.textDrawParams.color = exports[GetCurrentResourceName()]:getColorFromValue(value)
                end,
                ...
                draw = function(y)
                    ...
                    exports[GetCurrentResourceName()]:drawTextLabel(self._textGxtName, {CAS.initialX, y}, self.textDrawParams)
                end,
            ...
            PlayerTimerBar = {
                draw = function(y)
                    ...
                    exports[GetCurrentResourceName()]:drawTextLabel(self._titleGxtName, {CAS.initialX, y + CAS.playerTitleOffset}, titleDrawParams)
                    exports[GetCurrentResourceName()]:drawTextLabel(self._textGxtName, {CAS.initialX, y + CAS.textOffset}, self.textDrawParams)
                end
            },
            CheckpointTimerBar = {
                ...
                setColor = function(value)
                    self._color = exports[GetCurrentResourceName()]:getColorFromValue(value)
                end,

                setInProgressColor = function(value)
                    self._inProgressColor  = exports[GetCurrentResourceName()]:getColorFromValue(value)
                end,

                setFailedColor = function(value)
                    self._failedColor  = exports[GetCurrentResourceName()]:getColorFromValue(value)
                end,
            ...
            BarTimerBar = {
                ...
                setProgress = function(value)
                    self._progress = exports[GetCurrentResourceName()]:clamp(value, 0.0, 1.0)
                    self._fgWidth = CAS.progressWidth * self._progress
                    self._fgX = (CAS.progressBaseX - CAS.progressWidth * 0.5) + (self._fgWidth * 0.5)
                end,

                setBackgroundColor = function(value)
                    self._bgColor = exports[GetCurrentResourceName()]:getColorFromValue(value)
                end,

                setForegroundColor = function(value)
                    self._fgColor = exports[GetCurrentResourceName()]:getColorFromValue(value)
                end,
        ...
        setTitleColor = function(value)
            self.titleDrawParams.color = exports[GetCurrentResourceName()]:getColorFromValue(value)
        end,

        setHighlightColor = function(value)
            self._highlightColor = value and exports[GetCurrentResourceName()]:getColorFromValue(value) or nil
        end,
        ...
        drawTitle = function(y)
            exports[GetCurrentResourceName()]:drawTextLabel(self._titleGxtName, {CAS.initialX, y}, self.titleDrawParams)
        end,
